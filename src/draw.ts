...
function drawScene(gl: WebGLRenderingContext, programInfo: ProgramInfo, buffers: Buffers) {
    ...
    // note: glMatrix always has the first argumentas the destination to receive the result.
   ...
   gl.uniformMatrix4fv(programInfo.uniformLocations.projectionMatrix, false, projectionMatrix as Float32List);
